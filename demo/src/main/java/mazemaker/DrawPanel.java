...
public class DrawPanel extends JPanel implements Serializable{
    ...
    public static void addTab1(JTabbedPane pageArray, Portals label) {
        ...
        // X座標
        JLabel xLabel = new JLabel("X 座標:");
        xLabel.setFont(new Font("Microsoft YaHei", Font.BOLD, 16));
        gbc.gridx = 0; gbc.gridy = 0;
        editPanel.add(xLabel, gbc);
        gbc.gridx = 1; gbc.gridy = 0;
        editPanel.add(xField, gbc);
        ...
        // Y座標
        JLabel yLabel = new JLabel("Y 座標:");
        yLabel.setFont(new Font("Microsoft YaHei", Font.BOLD, 16));  
        gbc.gridx = 0; gbc.gridy = 1;
        editPanel.add(yLabel, gbc);
        gbc.gridx = 1; gbc.gridy = 1;
        editPanel.add(yField, gbc);
        ...
        // 寬度
        JLabel widthLabel = new JLabel("寬度:");
        widthLabel.setFont(new Font("Microsoft YaHei", Font.BOLD, 16));
        gbc.gridx = 0; gbc.gridy = 2;
        editPanel.add(widthLabel, gbc);
        gbc.gridx = 1; gbc.gridy = 2;
        editPanel.add(widthField, gbc);
        ...
        // 高度
        JLabel heightLabel = new JLabel("高度:");
        heightLabel.setFont(new Font("Microsoft YaHei", Font.BOLD, 16));
        gbc.gridx = 0; gbc.gridy = 3;
        editPanel.add(heightLabel, gbc);
        gbc.gridx = 1; gbc.gridy = 3;
        editPanel.add(heightField, gbc);
        ...
        IDLabel.setFont(new Font("Microsoft YaHei", Font.BOLD, 16));
        gbc.gridx = 0; gbc.gridy = 4;
        ...
        PIDLabel.setFont(new Font("Microsoft YaHei", Font.BOLD, 16));
